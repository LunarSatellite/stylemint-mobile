...
import 'package:stylemint_mobile_frontend/features/wallet/data/datasources/loyalty_remote_datasource.dart';
...
final loyaltyWalletProvider = FutureProvider.autoDispose<LoyaltyWallet>(
  (ref) => ref.watch(loyaltyRemoteDataSourceProvider).getWallet(),
);
