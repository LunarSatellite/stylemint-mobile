...
class CreatorPartnershipRequestsScreen extends StatelessWidget {
  ...
  static final _requests = [
    ...
    _PartnershipRequest(
      ...
      message: 'Hi there! We are launching a brand new segment of products inspired by fitness and sports enthusiasts. We really like the content you make in this genre and we are hoping to...',
      followers: '180k',
      likes: '3k',
      posts: '800+',
      rating: '4.7',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Creator Partnership Requests', style: DesignTokens.oneLinerSemibold),
      ),
      body: ListView.separated(
        ...
        itemBuilder: (context, index) => _RequestCard(
          ...
          onTap: () => Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => _PartnershipDetailScreen(request: _requests[index])),
          ),
        ),
      ),
    );
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: request.assetAvatar != null ? AssetImage(request.assetAvatar!) : null,
                  child: request.assetAvatar == null
                      ? Text(request.creatorName[0], style: DesignTokens.mediumSemibold.copyWith(color: DesignTokens.primaryGreen))
                      : null,
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        request.creatorName,
                        style: DesignTokens.smallRegular.copyWith(fontWeight: FontWeight.w700, color: DesignTokens.textWhite),
                      ),
                      Text(
                        request.handle,
            ...
            Row(
              children: [
                _Tag(label: request.niche, color: const Color(0xFF1A3A1A), textColor: DesignTokens.primaryGreen),
                const SizedBox(width: DesignTokens.s6),
                _Tag(label: '${request.followers} Followers', color: const Color(0xFF1A2A3A), textColor: const Color(0xFF4DA6FF)),
              ],
            ),
            const SizedBox(height: DesignTokens.s8),
            // Audience
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: OutlinedButton(
                      ...
                      child: Text('Decline', style: DesignTokens.smallRegular.copyWith(color: DesignTokens.textWhite, fontSize: 12)),
                    ),
                  ),
                ),
                const SizedBox(width: DesignTokens.s8),
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Accept', style: DesignTokens.smallRegular.copyWith(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 12)),
                    ),
                  ),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Partnership Request Detail', style: DesignTokens.oneLinerSemibold),
        actions: [
          Padding(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: request.assetAvatar != null ? AssetImage(request.assetAvatar!) : null,
                  child: request.assetAvatar == null
                      ? Text(request.creatorName[0], style: DesignTokens.titleLarge.copyWith(color: DesignTokens.primaryGreen))
                      : null,
                ),
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(request.creatorName, style: DesignTokens.mediumSemibold),
                      Text(request.handle, style: DesignTokens.smallRegular.copyWith(color: DesignTokens.textMuted, fontSize: 11)),
                      const SizedBox(height: 4),
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: DesignTokens.s8, vertical: 3),
                        decoration: BoxDecoration(
            ...
            const SizedBox(height: DesignTokens.s12),
            // Message
            Text('Message', style: DesignTokens.smallRegular.copyWith(color: DesignTokens.textMuted, fontSize: 12)),
            const SizedBox(height: 4),
            Text(request.message, style: DesignTokens.smallRegular.copyWith(color: const Color(0xFFD4D4D8))),
            const SizedBox(height: DesignTokens.s16),
            // Creator Profile Metrics
            Text('Creator Profile Metrics', style: DesignTokens.smallRegular.copyWith(fontWeight: FontWeight.w700, color: DesignTokens.textWhite)),
            const SizedBox(height: DesignTokens.s12),
            GridView.count(
              crossAxisCount: 3,
              shrinkWrap: true,
            ...
            const SizedBox(height: DesignTokens.s16),
            // Sample Content
            Text('Sample Content', style: DesignTokens.smallRegular.copyWith(fontWeight: FontWeight.w700, color: DesignTokens.textWhite)),
            const SizedBox(height: DesignTokens.s8),
            SizedBox(
              height: 100,
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Courier Offer', style: DesignTokens.smallRegular.copyWith(fontWeight: FontWeight.w700, color: DesignTokens.textWhite)),
                        Text('Free product sample included in partnership', style: DesignTokens.smallRegular.copyWith(color: DesignTokens.textMuted, fontSize: 11)),
                      ],
                    ),
                  ),
                ],
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('Accept Request', style: DesignTokens.smallRegular.copyWith(color: Colors.black, fontWeight: FontWeight.w700)),
              ),
            ),
            const SizedBox(height: DesignTokens.s8),
            // Decline button
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                child: Text('Decline Request', style: DesignTokens.smallRegular.copyWith(color: DesignTokens.textWhite, fontWeight: FontWeight.w600)),
              ),
            ),
            const SizedBox(height: DesignTokens.s16),
          ],
          ...
          child: Column(
            ...
            children: [
              ...
              Icon(
                ...
                color: isAccept ? DesignTokens.primaryGreen : DesignTokens.colorError,
                size: 48,
              ),
              const SizedBox(height: DesignTokens.s12),
              Text(
                isAccept ? 'Accept Partnership Request?' : 'Decline Partnership Request?',
                  ...
                  Expanded(
                    child: SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: Text('Cancel', style: DesignTokens.smallRegular.copyWith(color: DesignTokens.textWhite)),
                      ),
                    ),
                  ),
                  const SizedBox(width: DesignTokens.s8),
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: isAccept ? DesignTokens.primaryGreen : DesignTokens.colorError,
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                        ),
                        child: Text(
...
class _Tag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: DesignTokens.s6, vertical: 3),
      decoration: BoxDecoration(color: color, borderRadius: BorderRadius.circular(12)),
      child: Text(label, style: TextStyle(fontFamily: DesignTokens.fontFamily, fontSize: 10, color: textColor, fontWeight: FontWeight.w500)),
    );
  }
}
...
class _MetricTile extends StatelessWidget {
  const _MetricTile({required this.assetIcon, required this.value, required this.label});
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(value, style: DesignTokens.smallRegular.copyWith(fontWeight: FontWeight.w700, color: DesignTokens.textWhite, fontSize: 15)),
