...
class ChangePaymentMethodScreen extends StatefulWidget {
  ...
  @override
  State<ChangePaymentMethodScreen> createState() =>
      _ChangePaymentMethodScreenState();
}
                ...
                return Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(
                      right: p.id != _platforms.last.id ? DesignTokens.s8 : 0,
                    ),
...
enum _PlatformType {
  ...
  Widget buildIcon() {
    switch (this) {
      ...
      case paypal:
        return Image.asset(
          'assets/images/vendordashboard/PayPal.png',
          width: 36,
          height: 36,
          fit: BoxFit.contain,
        );
      case venmo:
        return Image.asset(
          'assets/images/vendordashboard/venmo.png',
          width: 36,
          height: 36,
          fit: BoxFit.contain,
        );
